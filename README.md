...
pytest -q                              # 42 checks (or: PYTHONPATH=. python tests/test_reproduction.py)
```
...
| PUF uniqueness, 100 dies (Fig 5) | **49.97%** | **48.92%** feed-forward mesh | sim |
| PUF uniformity, 100 dies (Fig 5) | **50.15%** | **49.39%** feed-forward mesh | sim |
| PUF uniqueness, recirculating mesh | **49.97%** | **49.97%** / **49.99%** (two stated wirings) | sim |
| PUF uniformity, recirculating mesh | **50.15%** | **49.32%** / **49.39%** (two stated wirings) | sim |
...
not a guessed op-count — see [`docs/REPRODUCTION_REPORT_v6.md`](docs/REPRODUCTION_REPORT_v6.md) §6.
...
├── tests/
│   └── test_reproduction.py          42 checks (pytest or standalone)
├── data/
...
└── docs/
    ├── REPRODUCTION_REPORT_v6.md     full scope map, per-result table, parameter provenance
    ├── REPRODUCTION_REPORT_v5.md     the previous report
    ├── REPRODUCTION_REPORT_v4.md     the report before that
    ├── REPRODUCTION_REPORT_v3.md     earlier reports, kept for history
...
(details in [`docs/REPRODUCTION_REPORT_v6.md`](docs/REPRODUCTION_REPORT_v6.md) §6). The
parameters that are not from the paper, with their sources where recorded, are listed in
docs/REPRODUCTION_REPORT_v6.md §6.3:
...
provenance is in docs/REPRODUCTION_REPORT_v6.md §6.
...
- Directional-coupler dispersion, propagation loss, grating-coupler references and the
  ...
  [`docs/REPRODUCTION_REPORT_v6.md`](docs/REPRODUCTION_REPORT_v6.md) §6.3. The superseded
  document search list is kept for history only; current parameter provenance is in
  docs/REPRODUCTION_REPORT_v6.md §6.
