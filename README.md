...
On a typical laptop CPU, `scripts/run_all.py` takes about 11 minutes, most of which is
the ten-seed Iris sweep and the Fig 4d bootstraps, and the test suite takes about
3 minutes. No datasets to
...
| Switch crosstalk (Fig 4d,e) | −45 to <−20 dB | CMT model fitted to Fig 4d: −27.2 to −21.1 dB at 1560 nm; worst −16.8 dB over the fitted 1549–1565 nm, −11.8 dB extrapolated over 1530–1549 nm | sim |
...
└── docs/
    ├── REPRODUCTION_REPORT_v3.md     full scope map, per-result table, parameter provenance
    ├── REPRODUCTION_REPORT_v2.md     the previous report
...
```bash
python scripts/fit_fig4.py       # → mesh fit λ₀=1574.7 nm, slope=0.0026 rad/nm, RMS 0.79 dB; writes figures/fig4_digitized.png
```
